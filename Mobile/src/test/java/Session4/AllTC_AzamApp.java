...
public class AllTC_AzamApp extends base {
	...
	public void test2() throws MalformedURLException, InterruptedException {
        ...
        log("Search specific Movie....->using search option");
		Home.tapOnSearchIcon();
		Search.SearchMovie("keeping promises");
		Search.VerifySearchedMovie();
